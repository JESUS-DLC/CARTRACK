...
public interface ServiceFacade {
    ...
    TotalCostServicesDto getTotalCostServices();
    PageableResponse<ServiceResponseDto> findAllServices(Pageable pageable,BigInteger minCost, BigInteger maxCost, LocalDate date, Boolean status);
